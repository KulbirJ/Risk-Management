    ...
    <div className="bg-white rounded-lg border border-gray-200 p-6 mb-6">
      <div className="flex items-center justify-between mb-4">
        <div className="flex items-center gap-2">
          ...
          <div>
            <h3 className="text-lg font-semibold text-gray-900">Threat Intelligence Enrichment</h3>
            <p className="text-sm text-gray-500">Dual-track enrichment: CVE-based + ATT&CK sector frequency</p>
          </div>
        </div>
      ...
      {result && (
        <div className="p-4 bg-green-50 border border-green-200 rounded-lg mb-4">
          <div className="flex items-center gap-2 mb-2">
            ...
            <span className="text-sm font-semibold text-green-800">Enrichment Complete</span>
          </div>
          <div className="grid grid-cols-2 gap-4 text-sm">
            <div>
              <span className="text-green-600">Threats Enriched:</span>
              <span className="ml-2 font-bold text-green-800">{result.threats_enriched}</span>
            </div>
            <div>
              <span className="text-green-600">Status:</span>
              <span className="ml-2 font-bold text-green-800">{result.status}</span>
            </div>
          </div>
        </div>
      )}
